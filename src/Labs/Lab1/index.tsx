...
<div id="wd-your-favorite-recipe">
    ...
    <ol>
        <li>Open your blender</li>
        <li>Add 1 cup of Strawberries</li>
        <li>Add 1/2 cup of Bananas</li>
        <li>Add 1/2 cup of Blueberries</li>
        <li>Add 1 cup of Yougurt</li>
        <li>Add 1/2 cup of Water</li>
        <li>Blend until all ingredients are mixed!</li>
    </ol>
</div>
