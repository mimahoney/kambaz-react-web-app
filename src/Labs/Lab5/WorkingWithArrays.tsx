...
<h3>Updating an Item in an Array</h3>
    ...
    className="w-25" onChange={(e) => setTodo({ ...todo, description: e.target.value })}/>
    <br /><br /><hr />
    ...
    <a
    href={`${API}/${todo.id}/completed/${todo.completed}`} className="btn btn-primary float-end">
    Update Completed
    </a>
    <FormCheck type="checkbox" label="Completed"
